...
| --------------- | ----------------------------------------------------------------------------------------------------- | ------------------------------------------ |
| AC-014-001..012 | Detalle auditable en la sección `Evidencia auditable por criterio`, con comandos y artefactos por AC. | verified; revisión independiente pendiente |
