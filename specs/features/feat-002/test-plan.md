...
|---|---|---|---|---|
| TEST-002-001 | E2E | AC-002-001 | `pnpm test:e2e --grep auth-client` | pendiente: selector propio, Google, OTP email y ausencia de opciones no autorizadas |
| TEST-002-002 | integración/E2E staging | AC-002-002 | `pnpm test:security --grep auth-provisioning` y acceso manual con MFA | parcial: adaptador y deduplicación locales; falta acceso MFA en staging |
