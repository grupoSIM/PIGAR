...
|---|---|---|---|---|
| TEST-002-001 | E2E/manual staging | AC-002-001 | `pnpm test:e2e --grep auth-client` y acceso OTP no productivo | pass: selector propio OTP-only y acceso manual del usuario validados sobre la imagen desplegada el 2026-08-02; Google no se presentó. |
| TEST-002-002 | integración/E2E staging | AC-002-002 | `pnpm test:security --grep auth-provisioning` y acceso manual con MFA | pass: adaptador/deduplicación y acceso manual administrativo con MFA validados sobre la imagen desplegada el 2026-08-02. |
