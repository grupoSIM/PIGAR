...
| TEST-007-016 | CI/release              | Imágenes del mismo SHA se publican sólo si calidad completa pasa en `staging`; fallo/cancelación las omite (AC-007-017).                | `pnpm test:ci-contract`; inspección de dependencias y ejecución remota de GitHub Actions                | pass — contrato 3/3 + run 33338559977                   |
